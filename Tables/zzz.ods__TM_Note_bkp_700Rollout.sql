...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Note__InsertD__5DCAEF64] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Note__UpdateD__5EBF139D] DEFAULT (getdate()),
