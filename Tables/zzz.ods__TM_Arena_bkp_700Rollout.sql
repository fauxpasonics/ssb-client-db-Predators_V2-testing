...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Arena__Insert__02FC7413] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Arena__Update__03F0984C] DEFAULT (getdate()),
