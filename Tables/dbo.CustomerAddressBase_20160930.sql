CREATE TABLE [dbo].[CustomerAddressBase_20160930]
(
...
GO
ALTER TABLE [dbo].[CustomerAddressBase_20160930] ADD CONSTRAINT [cndx_PrimaryKey_CustomerAddress_2] PRIMARY KEY NONCLUSTERED  ([CustomerAddressId])
GO
