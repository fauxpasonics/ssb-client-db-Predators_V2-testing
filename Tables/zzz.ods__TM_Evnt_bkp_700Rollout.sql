...
[Season_id] [int] NULL,
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Evnt__InsertD__30C33EC3] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Evnt__UpdateD__31B762FC] DEFAULT (getdate()),
