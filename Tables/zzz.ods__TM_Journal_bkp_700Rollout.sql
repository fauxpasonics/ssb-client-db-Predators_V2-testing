...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Journa__Inser__3E1D39E1] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Journa__Updat__3F115E1A] DEFAULT (getdate()),
