...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceUnMe__Creat__39E8240A] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceUnMe__Updat__3ADC4843] DEFAULT (getdate()),
