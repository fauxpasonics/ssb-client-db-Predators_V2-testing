...
[EventDate] [datetime] NOT NULL CONSTRAINT [DF__EventLog__EventD__08B54D69] DEFAULT (getdate()),
[ExecutionId] [uniqueidentifier] NOT NULL CONSTRAINT [DF__EventLog__Execut__09A971A2] DEFAULT (newid()),
