CREATE TABLE [prodcopy].[xCustomerAddress]
(
...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__CustomerA__CopyL__52CE3E04] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[xCustomerAddress] ADD CONSTRAINT [PK__Customer__B4F003156D83DD8F] PRIMARY KEY CLUSTERED  ([customeraddressid])
GO
