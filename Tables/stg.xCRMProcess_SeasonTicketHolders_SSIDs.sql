CREATE TABLE [stg].[xCRMProcess_SeasonTicketHolders_SSIDs]
(
...
GO
ALTER TABLE [stg].[xCRMProcess_SeasonTicketHolders_SSIDs] ADD CONSTRAINT [PK_CRMProcess_SeasonTicketHolders_SSIDs] PRIMARY KEY CLUSTERED  ([SSID], [SeasonYear])
GO
