...
[ETL_CreatedDate] [datetime] NULL CONSTRAINT [DF__TMAPI_Att__ETL_C__66EA454A] DEFAULT (getdate()),
...
GO
ALTER TABLE [src].[TMAPI_AttendanceResult] ADD CONSTRAINT [PK__TMAPI_At__7EF6BFCDA0485B71] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
