...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__Opportuni__CopyL__5B638405] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[xOpportunity] ADD CONSTRAINT [PK__Opportun__736BF79C588C98D8] PRIMARY KEY CLUSTERED  ([opportunityid])
GO
