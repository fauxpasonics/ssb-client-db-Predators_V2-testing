...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__InsertDa__7EF6D905] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__UpdateDa__7FEAFD3E] DEFAULT (getdate()),
