...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeat__Created__29572725] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeat__Updated__2A4B4B5E] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimSeat__IsDelet__2B3F6F97] DEFAULT ((0)),
[DeleteDate] [datetime] NULL CONSTRAINT [DF__DimSeat__DeleteD__2C3393D0] DEFAULT ((0)),
