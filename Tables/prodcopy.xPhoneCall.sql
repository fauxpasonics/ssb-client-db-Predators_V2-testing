CREATE TABLE [prodcopy].[xPhoneCall]
(
...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__PhoneCall__CopyL__63F8CA06] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[xPhoneCall] ADD CONSTRAINT [PK__PhoneCal__0FC8C7C4C3202484] PRIMARY KEY CLUSTERED  ([activityid])
GO
