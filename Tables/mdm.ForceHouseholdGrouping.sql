...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceHous__Creat__4DEF1CB7] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__ForceHous__Updat__4EE340F0] DEFAULT (getdate()),
