...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Inser__44CA3770] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Updat__45BE5BA9] DEFAULT (getdate()),
