...
[ETL__CreatedDate] [datetime] NULL CONSTRAINT [DF__TicketTag__ETL____447D231B] DEFAULT (getdate()),
[ETL__UpdatedDate] [datetime] NULL CONSTRAINT [DF__TicketTag__ETL____45714754] DEFAULT (getdate()),
