CREATE TABLE [prodcopy].[xSystemUser]
(
[accessmode] [int] NULL,
...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__SystemUse__CopyL__733B0D96] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[xSystemUser] ADD CONSTRAINT [PK__SystemUs__E4276C1F45609784] PRIMARY KEY CLUSTERED  ([systemuserid])
GO
