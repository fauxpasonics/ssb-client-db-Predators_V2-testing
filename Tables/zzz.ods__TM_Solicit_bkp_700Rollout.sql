...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Inser__70A8B9AE] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Updat__719CDDE7] DEFAULT (getdate()),
