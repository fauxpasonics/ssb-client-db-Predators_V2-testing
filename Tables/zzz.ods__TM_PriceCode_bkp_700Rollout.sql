...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Inser__55F4C372] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Updat__56E8E7AB] DEFAULT (getdate()),
