...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_HeldSe__Inser__37703C52] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_HeldSe__Updat__3864608B] DEFAULT (getdate()),
