CREATE TABLE [dbo].[ContactBase_20160928]
(
...
GO
ALTER TABLE [dbo].[ContactBase_20160928] ADD CONSTRAINT [cndx_PrimaryKey_Contact_20160928] PRIMARY KEY CLUSTERED  ([ContactId])
GO
