...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Insert__4F47C5E3] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Update__503BEA1C] DEFAULT (getdate()),
