...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Creat__33D4B598] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimSeason__Updat__34C8D9D1] DEFAULT (getdate()),
[IsDeleted] [bit] NULL CONSTRAINT [DF__DimSeason__IsDel__35BCFE0A] DEFAULT ((0)),
