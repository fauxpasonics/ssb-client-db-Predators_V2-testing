CREATE TABLE [dbo].[xCRMProcess_DistinctContacts]
(
...
GO
ALTER TABLE [dbo].[xCRMProcess_DistinctContacts] ADD CONSTRAINT [PK_CRMProcess_DistinctContacts] PRIMARY KEY CLUSTERED  ([SSB_CRMSYSTEM_CONTACT_ID])
GO
