...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Inser__17F790F9] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Updat__18EBB532] DEFAULT (getdate()),
