...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Ticket__Inser__656C112C] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Ticket__Updat__66603565] DEFAULT (getdate()),
...
GO
CREATE CLUSTERED INDEX [IDX_TM_Ticket_TicketStatus] ON [zzz].[ods__TM_Ticket_bkp_700Rollout] ([ticket_status])
GO
CREATE NONCLUSTERED INDEX [idx_tm_ticket_ticket_status_covering] ON [zzz].[ods__TM_Ticket_bkp_700Rollout] ([ticket_status]) INCLUDE ([acct_id], [acct_Rep_id], [add_datetime], [block_purchase_price], [class_name], [comp_code], [event_id], [ledger_id], [num_seats], [order_line_item], [order_num], [orig_acct_rep_id], [plan_event_id], [price_code], [pricing_method], [promo_code], [row_id], [seat_num], [section_id], [sell_location], [tran_type])
GO
CREATE NONCLUSTERED INDEX [IDX_ticket_status] ON [zzz].[ods__TM_Ticket_bkp_700Rollout] ([ticket_status]) INCLUDE ([acct_id], [event_id], [id], [num_seats], [plan_event_id], [return_reason], [row_id], [seat_num], [section_id])
GO
