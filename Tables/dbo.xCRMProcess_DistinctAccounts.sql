CREATE TABLE [dbo].[xCRMProcess_DistinctAccounts]
(
...
GO
ALTER TABLE [dbo].[xCRMProcess_DistinctAccounts] ADD CONSTRAINT [PK_CRMProcess_DistinctAccounts] PRIMARY KEY CLUSTERED  ([SSB_CRMSYSTEM_ACCT_ID])
GO
