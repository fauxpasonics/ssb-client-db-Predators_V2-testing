CREATE TABLE [wrk].[xcustomerWorkingList]
(
...
GO
ALTER TABLE [wrk].[xcustomerWorkingList] ADD CONSTRAINT [PK_customerWorkingList] PRIMARY KEY CLUSTERED  ([SSB_CRMSYSTEM_ACCT_ID])
GO
