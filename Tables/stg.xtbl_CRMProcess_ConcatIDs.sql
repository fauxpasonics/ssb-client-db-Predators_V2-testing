CREATE TABLE [stg].[xtbl_CRMProcess_ConcatIDs]
(
...
GO
ALTER TABLE [stg].[xtbl_CRMProcess_ConcatIDs] ADD CONSTRAINT [PK__tbl_CRMP__43A3E834242E17B6] PRIMARY KEY CLUSTERED  ([GUID])
GO
