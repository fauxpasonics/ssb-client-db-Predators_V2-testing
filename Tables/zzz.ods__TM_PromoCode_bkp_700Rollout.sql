...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_PromoC__Inser__5CA1C101] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_PromoC__Updat__5D95E53A] DEFAULT (getdate()),
