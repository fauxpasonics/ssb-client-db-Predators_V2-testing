...
GO
ALTER TABLE [dbo].[xAccount] ADD CONSTRAINT [PK_Account] PRIMARY KEY CLUSTERED  ([SSB_CRMSYSTEM_ACCT_ID])
GO
CREATE UNIQUE NONCLUSTERED INDEX [UIDX_dboAccount_crmid] ON [dbo].[xAccount] ([crm_id])
GO
