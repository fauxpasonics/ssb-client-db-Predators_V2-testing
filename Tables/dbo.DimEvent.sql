...
[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimEvent__Create__4CA06362] DEFAULT (getdate()),
[UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__DimEvent__Update__4D94879B] DEFAULT (getdate()),
[IsDeleted] [bit] NOT NULL CONSTRAINT [DF__DimEvent__IsDele__4E88ABD4] DEFAULT ((0)),
[DeleteDate] [datetime] NULL,
[IsClosed] [bit] NOT NULL CONSTRAINT [DF__DimEvent__IsClos__4F7CD00D] DEFAULT ((0)),
