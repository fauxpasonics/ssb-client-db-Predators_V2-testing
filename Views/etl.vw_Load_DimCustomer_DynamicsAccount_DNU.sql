...
CREATE VIEW [etl].[vw_Load_DimCustomer_DynamicsAccount_DNU]
AS
    (
      SELECT *
	/*Name*/
...
/*Extended Attributes*/
      ...
      , a2.WebSiteURL AS [ExtAttribute2]
...
/*Source Created and Updated*/
	  ...
	  , CASE WHEN str_number LIKE '%,%' THEN SUBSTRING(str_Number,0, CHARINDEX(',', str_number))
		ELSE str_number END AS [Customer_Matchkey]
      , 1 IsBusiness

--		select top 100 *
		FROM    Predators_Reporting.prodcopy.account AS a2 WITH ( NOLOCK )
		WHERE 1 = 1
