...
CREATE VIEW [etl].[crm_migration_update_20160930] AS
SELECT cb.ContactId ,
...
JOIN dbo.ContactBase_20160930 cb ON base.ContactId = cb.ContactId
JOIN dbo.CustomerAddressBase_20160930 cab ON cb.ContactId = cab.ParentId
