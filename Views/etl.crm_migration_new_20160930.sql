...
CREATE VIEW [etl].[crm_migration_new_20160930] AS
SELECT cb.ContactId ,
       ...
       cab.PostOfficeBox ,
       cab.PostalCode
FROM dbo.ContactBase_20160930 cb
LEFT JOIN dbo.CustomerAddressBase_20160930 cab ON cb.ContactId = cab.ParentId
LEFT JOIN dbo.ContactBase crm ON cb.ContactId = crm.ContactId
WHERE crm.contactid IS NULL AND (cb.CreatedOn > '2016-08-29')
AND cab.AddressNumber = 1 AND cab.AddressTypeCode IS NULL
AND cb.statecode = 0 AND cb.merged = 0
