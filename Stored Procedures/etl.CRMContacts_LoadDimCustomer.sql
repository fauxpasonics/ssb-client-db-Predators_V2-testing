...
--drop table #temp
		...
		CREATE CLUSTERED INDEX IDX_LoadKey
...
/***Standard and Extended Attributes***/
	...
	--, myTarget.SalutationName = mySource.SalutationName
        ...
        FROM    dbo.DimCustomer t WITH (NOLOCK)
		LEFT JOIN predators_reporting.prodcopy.contact b ON t.sourcesystem = 'CRM_Contacts' AND CAST(t.ssid AS NVARCHAR(100)) = CAST(b.contactid AS NVARCHAR(100))
