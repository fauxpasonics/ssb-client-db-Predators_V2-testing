...
OR		(SeasonCode = 'PRED1718' AND PC4 IN ('R', 'F', 'C', 'A'))
...
OR		(SeasonCode = 'PRED1718' AND PC4 = 'W')
...
OR		(SeasonCode = 'PRED1718' AND (PC4 NOT IN ('N','R','F','A','E','U','W','C') OR PC4 IS NULL))
...
OR		(SeasonCode = 'PRED1718' AND (PC3 = 'F' OR ItemCode LIKE '17FS%'))
...
OR		(SeasonCode = 'PRED1718' AND PlanCode LIKE '17HPG%')
...
OR		(SeasonCode = 'PRED1718' AND PlanCode LIKE '17HPB%')
...
FROM    #stgFactTicketSales fts
        ...
        JOIN dbo.DimDate DimDate ON DimDate.DimDateId = fts.DimDateId	
		JOIN dbo.DimSeason season ON season.DimSeasonId = fts.DimSeasonId
WHERE	(SeasonCode = 'PRED1718' AND PlanCode LIKE '17HPP%')
...
FROM    #stgFactTicketSales fts
		...
		JOIN dbo.DimSeason season ON season.DimSeasonId = fts.DimSeasonId
		JOIN dbo.dimplan p ON p.DimPlanId = fts.DimPlanId
WHERE	PC3 = 'H' AND PriceCodeDesc LIKE '%Suite%'
...
OR		(SeasonCode = 'PRED1718' AND (PC3 NOT IN ('F','H','X','Q','Y') OR PC3 IS NULL) AND (PC2 NOT IN ('G') OR PC2 IS NULL)
...
OR		(SeasonCode = 'PRED1718' AND PC4 = 'N' AND PC3 = 'F' AND PC2 = '0')
...
FROM    #stgFactTicketSales fts
        ...
        JOIN dbo.DimDate DimDate ON DimDate.DimDateId = fts.DimDateId	
		JOIN dbo.DimSeason season ON season.DimSeasonId = fts.DimSeasonId
WHERE	(SeasonCode = 'PRED1718' AND PC4 = 'N' AND PC3 = 'F' AND PC2 = '1')
...
OR		(SeasonCode = 'PRED1718' AND PC4 IN ('R', 'A', 'F') AND PC3 = 'F' AND PC2 = '0')
...
OR		(SeasonCode = 'PRED1718' AND PC4 IN ('R', 'A', 'F') AND PC3 = 'F' AND PC2 = '4')
...
OR		(SeasonCode = 'PRED1718' AND PC4 = 'U' AND PC3 = 'F' AND PC2 = '0')
...
FROM    #stgFactTicketSales fts
        ...
        JOIN dbo.DimDate DimDate ON DimDate.DimDateId = fts.DimDateId	
		JOIN dbo.DimSeason season ON season.DimSeasonId = fts.DimSeasonId
WHERE	(SeasonCode = 'PRED1718' AND PC4 = 'W' AND PC3 = 'F' AND PC2 = '1')
...
OR		(SeasonCode = 'PRED1718' AND PC4 = 'N' AND PC3 = 'H' AND PriceCodeDesc LIKE '%Suite%')
...
OR		(SeasonCode = 'PRED1718' AND PC4 IN ('R', 'A', 'F') AND PC3 = 'H' AND PriceCodeDesc LIKE '%Suite%')
...
OR		(SeasonCode = 'PRED1718' AND PC4 = 'N' AND PC3 = 'X')
...
OR		(SeasonCode = 'PRED1718' AND PC4 IN ('R', 'A', 'F') AND PC3 = 'X')
